Во многих языках помимо условной конструкции *if* есть **switch**. Эта конструкция встречается в огромном количестве существующего PHP-кода, поэтому ее важно уметь читать.
