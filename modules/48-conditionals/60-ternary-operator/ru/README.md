...
Но можно записать более лаконично. В PHP есть конструкция, которая работает как _if-else_, но при этом является выражением — ее результат можно сразу вернуть из функции. Она называется **тернарный оператор** и является единственным оператором в PHP, который требует три операнда:
