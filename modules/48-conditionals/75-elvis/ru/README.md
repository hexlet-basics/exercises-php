...
Оператор `?:` — бинарный оператор, который возвращает первый операнд если он истинен, и второй в ином случае. Еще его называют Elvis, потому что это слово похоже на _else if_. А еще из-за визуального сходства с Элвисом Пресли:
