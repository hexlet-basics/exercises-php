...
Реализуйте функцию `compress()`, которая сжимает строку методом RLE (Run-Length Encoding).
...
2. Как только символ меняется — записать предыдущий символ и счетчик (если больше 1)
