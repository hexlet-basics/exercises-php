...
В самом простом случае проверка запускает ваш код и сравнивает вывод на экран с ожидаемым результатом. Например, если задание звучит так: «Выведите число 10 на экран», то ваш код на PHP может выглядеть так:
