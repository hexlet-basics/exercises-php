...
Сегодня UTF-8 является стандартом по умолчанию в интернете, Linux, базах данных и редакторах кода. Исходный код PHP и строки в современных проектах тоже принято хранить в UTF-8.
...
- PHP хранит строку как последовательность байтов, поэтому при работе с файлами и базами данных кодировку иногда приходится указывать явно.
